...
namespace ICSimulator
{
    ...
    public class Config : ConfigGroup
    {
        ...
        public static bool useMemoryCoalescing = true;
        ...
        // Flattened butterfly
        public static bool bFtfly   = false;
        public static bool bDeflectLoopback = (bFtfly) ? true : false;
        public static bool bFixedBW = false;
        // Increase the packet size to model reduced bw on a link
        public static int reducedBW = 2;
        // for chipper
        public static bool sortnetInterleave = true;
        public static bool sortnetDeflect    = false; //deflect instead of loopback
        ...
        // -- AFC
        public static int afc_buf_per_vnet = 4;
        ...
        public static double selftuned_throttle_rate_cap = 0.95;
        ...
        // -- REAL self-tuned congestion control based on buffer util: hillclimbing based on above netutil-target-seeking
        public static int buffer_selftuned_quantum = 50;
        public static int buffer_selftuned_hillClimb_quantum = 1000;
        public static double buffer_selftuned_target_decrease = 0.02;
        public static double buffer_selftuned_target_increase = 0.01;
        public static double buffer_selftuned_drop_threshold = 0.95;

        public static int buffer_selftuned_reset_count = 5;
        public static double buffer_selftuned_max_drop = 0.85;
        ...
        public static double cluster_MPKI_threshold = 0; // little effect on overall performance
        public static bool always_cluster_enabled=true;
        public static bool low_cluster_filling_enabled=true;
        public static double low_apps_mpki_thresh=0;
        public static bool act_reverse_sort = false;
        public static bool bUseMPKC = false;

        // MSHR Throttling
        public static bool bACTThMSHR = false;
        public static bool bStepMSHR = false;

        // ACT on AFC Buffered
        public static bool bUseBufUtil = false;

        // Dynamic target adjustment
        public static bool bDynamicUtilTarget = false;
        public static bool bMaxIPCTarget = false;

        // Prioritization only
        public static bool bNoThrottle  = false; // without throttling
        public static bool bLowMPKIPrio = false;

        // Injectoin Swap Prioritization
        public static double lowMPKIPrio = 5;
        public static double highVictimMPKI = 50;
        public static double swapOutCountThreshold = 10;

        // MPKC based throttling
        public static ulong throttlePeriod   = 5000;
        public static int   neverClusterMPKC = 200;

        // Variable MSHR size
        public static string mshrSizeList = "";
        public static int[]  mshrsList;
        public static int[]  mshrsWatermark;
        public static double netutilRange = 0.01;
        public static double replyEjRange = 0.01;

        // Throttle MSHR based on ejection rate
        public static ulong  ejectMonitorPeriod     = 10000;
        public static double ejectRateHighThreshold = 0.9;
        public static double ejectRateLowThreshold  = 0.7;
        public static double ejectRateUpperBound    = 1.0;
        public static double ejectRateLowerBound    = 0.0;
        public static double mshrTh_netutil_target  = 1.0;

        // Hill climb netutil to find max throughput
        public static ulong  hillClimbQuantum     = 100000;
        public static double dropThreshold = 0.05;
        public static double resetHillThreshold = 0.1;
        public static double incStep = 0.04;
        public static double decStep = 0.02;

        public static bool ejectByReqID = false; // if false, look at my reply ejection rate
        public static bool throttleByLocalTotalEject = false;
        public static bool dynamicThreshold = false;
        public static bool useEstAloneEjRate = false;
        public static bool useInjRate = false;
        public static bool bThrottleMSHR = true;
        public static bool bResetCount = false;
        public static bool bHillClimb  = false;
        public static bool bClimbIPC   = false;
        public static bool bClimbMPKC  = false;
        ...
        public static bool   bHeteroSynthRate = true;
        public static double synthBaseRate = 0.01; // 10 MPKI
        public static string baseNode = "0,1,2,3";
        public static string twoNode = "4,5,6,7";
        public static string fourNode = "8,9,10,11";
        public static string eightNode = "12,13,14,15";
        // ----
...
// For GPU
        public static bool CPU = true;  // is this a GPU-only simulation
        public static int gpuLoc = 10000;
        public static ulong IAT_threshold = 120; // Interarrival Time Threshold for GPU applications
        public static ulong IAT_thres_delay = 5;
        public static int dedicatedGPUChannels = 0;
        // for Batcher
        public static ulong batcherTimeLimit = 100;
        public static int CPUBatchCap = 16;
        public static int GPUBatchCap = 50;
        public static int batchSchedulerBufferSize = 100;
        public static bool enableBatching = false;
        public static int triggerBatchingThresh = 8;
        public static bool cpuByPassBatcher = false;
        public static bool alwaysBatchGPU = false;

        public static double cpuBatchedRate = 1.0;

        public static ulong gpuBatchTime = 800;

        // for Batch Scheduler
        public static int batchSizeDiffCap = 4;
        public static int MaxGPURequestsFlush = 12;
        public static int gpuDispatchBarrier = 1600;
        // for fragmentbatcher
        public static int BatchSizeLimit = 50;
        // for shuffling in batch scheduler
        public static int coreStarvationShuffleLimit = 5;
        public static int gpuStarvationShuffleLimit = 100;
        // MOR+
        public static double MorPlusChance = 0.95;
        // GPUCap
        public static double QoSUpdateCycle = 10000000;
...
// End for GPU
       ...
       // 741: BLESS-CC Congestion Avoidance Variables
        ...
        // -- WOODCHIPPER -- HPCA 2012
        public static bool silverFlit        = false;
        public static int  ejectCount        = 1;     //Set to two for woodchipper
        public static bool deflDePrio        = false;

        public static bool resubmitBuffer    = false;
        public static int  rbSize            = 16;
        public static bool rbInfinite        = false;
        public static int  rbInjectCount     = 1;
        public static int  rbEjectCount      = 1;

        public static bool redirection       = true;
        public static int  redirectThreshold = 2;
        //public static int  redirectionLength = 1;
	...
	/* HWA CODE */
	public static int NumberOfNodeHavingShCache = 0; // 0 means not defined
        public static string hwaDeadLineList = "";
	public static string hwaDeadLineReqCntList = "";
	public static string hwaStartOffsetList = "";
	public static string hwaDeadLineMultiStartList = "";
	public static string hwaDeadLineMultiNumList = "";
	public static string hwaDeadLineMultiAllList = "";
	public static string hwaDeadLineReqMultiAllList = "";
	public static int HWANum = 0; 
	public static bool is_memQueue_InEntrance_Overtake = false;
	public static bool is_memQueue_priority_scheme = false;
	public static bool is_through_all_cache = false;
        public static string hwaEmergentThList = "";

	public static int ShaderNum = 0;
	public static bool GPUasHWA = false;
#if GPGPU_EXT
	public static KernelInfo kernel_info = new KernelInfo();
	public static int constant_cache_assoc = 4;
	public static int constant_cache_size = 14;
	public static int tex_cache_assoc = 4;
	public static int tex_cache_size = 14;
#endif

...
namespace ICSimulator
{
    public class ResubBuffer
    {
        ...
        public ResubBuffer()
        {
            buffer  = new List<Flit>(Config.rbSize);
            maxSize = Config.rbSize;
        }
        ...
        public int getNextFlitIndex()
        {
            ...
            //Disabled the other options for Kevin
            //Follows a fifo
            return 0;
...
//                    ret.wasInRebuf = true;
        ...
        public int count()
        {
        	if (buffer.Count < 0 || (buffer.Count > maxSize && !Config.rbInfinite))
